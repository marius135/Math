...
public class Pocketeer {
    ...
    private static void sendGet() throws Exception {
        ...
        String url = " https://fvjkpkflnc.execute-api.us-east-1.amazonaws.com/prod/traders" +
                "?x-api-key=gaqcRZE4bd58gSAJH3XsLYBo1EvwIQo88IfYL1L5";
    ...
    static Traders[] getTraders() throws Exception {
        Traders[] traders = new Traders[0];
        sendGet();
